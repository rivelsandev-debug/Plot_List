...
<body class="theme-app min-h-screen">
    ...
    <nav class="fixed top-0 w-full theme-header backdrop-blur-lg border-b shadow-lg z-50">
        <div class="px-4 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <img src="{{ asset('storage/logo/Desain tanpa judul (1).png') }}" alt="PlotList" class="h-20 w-auto">
    ...
    <footer class="theme-header border-t py-6">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <p class="theme-text-secondary text-sm">© {{ date('Y') }} PlotList. All rights reserved.</p>
        </div>
    </footer>
