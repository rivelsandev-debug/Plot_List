...
<?php endif; ?>
        ...
        <p class="text-center text-sm text-gray-400">
            Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-indigo-400 hover:text-indigo-300">
                Daftar sekarang
            </a>
        </p>
    </form>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\Plot_List\resources\views/auth/login.blade.php ENDPATH**/ ?>