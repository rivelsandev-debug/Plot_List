    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-between p-12 w-full">
                ...
                <p class="text-gray-500 text-sm">© <?php echo e(date('Y')); ?> PlotList. All rights reserved.</p>
            </div>
        </div>
...
<?php /**PATH D:\laragon\www\Plot_List\resources\views/layouts/guest.blade.php ENDPATH**/ ?>