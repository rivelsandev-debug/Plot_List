...
<?php endif; ?>
        ...
        <p class="text-center text-sm text-gray-400">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="font-semibold text-indigo-400 hover:text-indigo-300">
                Login sekarang
            </a>
        </p>
    </form>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\Plot_List\resources\views/auth/register.blade.php ENDPATH**/ ?>