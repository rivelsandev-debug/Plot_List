        ...
        <div class="max-w-5xl mx-auto px-6 lg:px-8 -mt-20 pb-16 relative z-10">
            <div class="grid gap-8" style="grid-template-columns: 220px 1fr;">
                    ...
                    <div class="theme-card border rounded-xl p-4 flex flex-col gap-3">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="theme-text-primary font-semibold">
                                <?php echo e(\Carbon\Carbon::parse($novel->release_date)->format('Y')); ?>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="theme-text-primary font-semibold">
                                <?php echo e(count(explode(',', $novel->genre))); ?> Genre
                            </span>
                        </div>
                        <div class="border-t theme-border"></div>
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="theme-text-primary font-semibold">
                                <?php echo e($novel->orders()->where('status', 'success')->count()); ?>
                ...
                <div class="flex flex-col gap-5 pt-20">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold theme-text-primary mb-1"><?php echo e($novel->title); ?></h1>
                        <p class="theme-text-secondary text-sm">oleh <span
                                class="theme-text-primary font-semibold"><?php echo e($novel->author); ?></span></p>
                    </div>
                        ...
                        <div class="flex items-center gap-2">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                ...
                                <?php elseif($i - $novel->rating < 1): ?>
                                    <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                        <defs>
                                            <linearGradient id="half-<?php echo e($i); ?>">
                                                <stop offset="50%" stop-color="currentColor" />
                                                <stop offset="50%" stop-color="transparent" />
                                            </linearGradient>
                                        </defs>
                                        <path fill="url(#half-<?php echo e($i); ?>)"
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    </svg>
                                <?php else: ?>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <?php $__currentLoopData = explode(',', $novel->genre); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $genre = trim($genre); ?>
                            <span
                                class="px-3 py-1.5 border text-xs font-semibold rounded-full <?php echo e($genreColors[$genre] ?? 'bg-blue-500/10 text-blue-400 border-blue-500/20'); ?>">
                                <?php echo e($genre); ?>
                    ...
                    <div class="theme-card border rounded-xl p-4 grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="theme-text-primary font-semibold text-sm"><?php echo e($novel->author); ?></p>
                        </div>
                        <div>
                            ...
                            <p class="theme-text-primary font-semibold text-sm">
                                <?php echo e(\Carbon\Carbon::parse($novel->release_date)->format('d F Y')); ?></p>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\Plot_List\resources\views/admin/novels/show.blade.php ENDPATH**/ ?>